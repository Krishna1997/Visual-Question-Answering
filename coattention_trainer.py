...
def collate_lines(seq_list):
    imgT, quesT, gT, a, b, c = zip(*seq_list)
    ...
    aT = [a[i] for i in seq_order]
    bT = [b[i] for i in seq_order]
    cT = [c[i] for i in seq_order]
    return imgT, quesT, gT, aT, bT, cT


class CoattentionNetTrainer(Trainer):
    """
